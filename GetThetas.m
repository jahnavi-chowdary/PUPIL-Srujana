function feature_vector_14 = GetThetas_Final()

% This function fits a 6th degree polynomial to each of the 3 sets of Light Simulation 
% and saves the Coefficients and R2 Score of the fitted polynomials.

% It also computes the Feature Vector which is the concatenation of the Thetas of the Set with maximum R2 Score 
% of the Right and Left Eye leading to a FV of size 14.
...
for i=1:3
    A_l_all(:,:,i)=csvread(strcat('Area_Size_Time_Cut_CSV\',num2str(i),'\InterpolatedRadius_Left.csv'));
    A_r_all(:,:,i)=csvread(strcat('Area_Size_Time_Cut_CSV\',num2str(i),'\InterpolatedRadius_Right.csv'));
end
